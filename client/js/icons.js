/**
 * icons.js — Oasis Pulse SVG Icon Library
 * All icons are inline SVG strings, sized via CSS (currentColor, width/height set by class).
 * Usage: document.querySelector('.icon-slot').innerHTML = ICONS.clock;
 *        Or inject via: el.insertAdjacentHTML('afterbegin', ICONS.clock);
 */
...
const ICONS = {
  ...
  students: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>`,
  ...
  /* ── Actions ── */
  clockIn: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/><polyline points="9 18 12 21 15 18"/></svg>`,

  clockOut: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/><polyline points="9 6 12 3 15 6"/></svg>`,
  ...
  qr: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="5" height="5"/><rect x="16" y="3" width="5" height="5"/><rect x="3" y="16" width="5" height="5"/><path d="M21 16h-3a2 2 0 0 0-2 2v3"/><line x1="21" y1="21" x2="21" y2="21"/><path d="M3 11V9h2"/><path d="M3 13v2"/><path d="M11 3h2v2"/><path d="M13 11V9"/><path d="M11 13h2v2h-2v2"/><path d="M15 13h2"/><path d="M17 11h2v2"/></svg>`,
  ...
  /* ── Time ── */
  timer: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><polyline points="12 6 12 12 15.5 15.5"/><path d="M16.51 17.35l-.35 3.83a2 2 0 0 1-3.99.01l-.35-3.84"/></svg>`,

  alarm: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="13" r="8"/><path d="M12 9v4l2 2"/><path d="M5 3L2 6"/><path d="M22 6l-3-3"/><line x1="6.38" y1="18.7" x2="4.81" y2="20.49"/><line x1="17.64" y1="18.7" x2="19.19" y2="20.49"/></svg>`,
  ...
  wave: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M18.37 2.63 14 7l-1.59-1.59a2 2 0 0 0-2.82 0L8 7l3 3 2.09-2.09A2 2 0 0 1 16 7.83V20a2 2 0 0 1-2 2"/><path d="M2 11.5a10.56 10.56 0 0 1 5-1.5"/></svg>`,

  party: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="m5.8 11.3-2.5 8.1 8.1-2.5"/><path d="M6 12 2.3 6.3C1.8 5.5 2.1 4.4 3 3.9s2-.1 2.5.7L9.2 10"/><path d="m14.5 20 5-5"/><path d="m14 7 3 3"/><path d="M20 4c0 1.1-.9 2-2 2s-2-.9-2-2 .9-2 2-2 2 .9 2 2z"/><path d="M14 20c0 1.1-.9 2-2 2s-2-.9-2-2 .9-2 2-2 2 .9 2 2z"/></svg>`,

  /* ── Toggle states ── */
  toggleOn: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="1" y="5" width="22" height="14" rx="7"/><circle cx="16" cy="12" r="3" fill="currentColor"/></svg>`,

  toggleOff: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="1" y="5" width="22" height="14" rx="7"/><circle cx="8" cy="12" r="3" fill="currentColor"/></svg>`,
...
/**
 * Renders an icon as an <span> with the SVG inside.
 * @param {string} name - key in ICONS object
 * @param {string} cls  - additional CSS classes
 * @param {string} size - CSS size string (default '1em')
 */
function icon(name, cls = '', size = '1em') {
  const svg = ICONS[name];
  if (!svg) return '';
  return `<span class="svg-icon ${cls}" style="display:inline-flex;align-items:center;justify-content:center;width:${size};height:${size};flex-shrink:0;" aria-hidden="true">${svg}</span>`;
}

/**
 * Replace the inner HTML of an element with an icon.
 * @param {string} selector - CSS selector
 * @param {string} name     - key in ICONS
 * @param {string} size     - CSS size string
 */
function setIcon(selector, name, size = '1.1em') {
